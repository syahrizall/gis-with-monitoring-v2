...
import { Bell, CheckCircle, XCircle, Clock, Search, Check, CheckCheck } from 'lucide-react';
...
export const AlertsPage: React.FC = () => {
  ...
  const filteredAlerts = alerts.filter(alert => {
    const matchesSearch = 
      alert.location?.nama?.toLowerCase().includes(searchTerm.toLowerCase()) ||
          ...
          {filteredAlerts.length > 0 ? (
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        <h3 className="text-sm font-medium text-gray-900">
                          {alert.location?.nama || 'Unknown Location'}
                        </h3>
                        {!alert.is_read && (
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-gray-500">
                {searchTerm || showUnreadOnly || typeFilter !== 'all'
                  ? 'No alerts match your filters' 
                  : 'System alerts will appear here when status changes occur'
                }
              </p>
            </div>
          )}
